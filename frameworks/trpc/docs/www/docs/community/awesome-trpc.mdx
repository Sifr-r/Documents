...
| Description                                                                                              | Link                                                         |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| tRPC Docs Generator - Auto generate interactive documentation for your tRPC APIs                         | https://github.com/liorcodev/trpc-docs-generator             |
...
| tRPC Studio - Swagger-like UI with input forms, Try It Out, output type visualization, and CLI extractor | https://github.com/sayefdeen/trpc-studio                     |
...
## 🧩 Extensions & community add-ons (part 3)
...
| **create-t3-turbo** - Clean and simple starter repo using the T3 Stack along with Expo React Native | https://github.com/t3-oss/create-t3-turbo                                                   |
...
## 🍀 Starting points, example projects, etc (part 2)
