...
## Generate a client from the spec (part 2)
...
- **Query Inputs** — GET requests encode input as `?input=`, not as individual query parameters
...
## Generate a client from the spec (part 3)
