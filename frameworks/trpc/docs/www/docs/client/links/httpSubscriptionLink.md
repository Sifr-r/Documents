...
## Headers and authorization / authentication (part 2)
...
## Headers and authorization / authentication (part 3)
...
type Operation = any;
namespace EventSourceLike { export type AnyConstructor = any; export type InitDictOf = any; }
// ---cut---
...
> = {
  ...
  eventSourceOptions?:
    ...
    | ((opts: {
        ...
        | EventSourceLike.InitDictOf
        | Promise<EventSourceLike.InitDictOf>);
};
```
