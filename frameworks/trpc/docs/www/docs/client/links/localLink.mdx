...
```ts twoslash
type AnyRouter = any;
type inferRouterContext = any;
type inferClientTypes = any;
type ErrorHandlerOptions = any;
type TransformerOptions = {};
// ---cut---
type LocalLinkOptions<TRouter extends AnyRouter> = {
  router: TRouter;
  createContext: () => Promise<inferRouterContext>;
  onError?: (opts: ErrorHandlerOptions<inferRouterContext>) => void;
} & TransformerOptions<inferClientTypes>;
```
