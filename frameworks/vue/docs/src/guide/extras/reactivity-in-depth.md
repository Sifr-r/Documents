...
## How Reactivity Works in Vue {#how-reactivity-works-in-vue} (part 2)
...
## Integration with External State Systems {#integration-with-external-state-systems} (part 2)
...
## Connection to Signals {#connection-to-signals} (part 2)
