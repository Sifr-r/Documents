...
## Building Custom Elements with Vue {#building-custom-elements-with-vue} (part 2)
...
## Building Custom Elements with Vue {#building-custom-elements-with-vue} (part 3)
...
## Building Custom Elements with Vue {#building-custom-elements-with-vue} (part 4)
...
## Non-Vue Web Components and TypeScript {#non-vue-web-components-and-typescript} (part 2)
...
## Web Components vs. Vue Components {#web-components-vs-vue-components} (part 2)
