...
## Prop Passing Details {#prop-passing-details} (part 2)
...
## One-Way Data Flow {#one-way-data-flow} (part 2)
...
## Prop Validation {#prop-validation} (part 2)
...
## Prop Validation {#prop-validation} (part 3)
