...
## CSS-Based Transitions {#css-based-transitions} (part 2)
...
## CSS-Based Transitions {#css-based-transitions} (part 3)
...
## CSS-Based Transitions {#css-based-transitions} (part 4)
...
## JavaScript Hooks {#javascript-hooks} (part 2)
