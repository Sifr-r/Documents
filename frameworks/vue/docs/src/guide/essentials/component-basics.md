...
## Using a Component {#using-a-component} (part 2)
...
## Passing Props {#passing-props} (part 2)
...
## Listening to Events {#listening-to-events} (part 2)
...
## in-DOM Template Parsing Caveats {#in-dom-template-parsing-caveats} (part 2)
