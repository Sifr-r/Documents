...
Astro provides two built-in components that you can use to display and optimize your images.  The `` component allows you to display responsive images and work with different formats and sizes. The `` component will optimize your images and allow you to pass in different formats and quality properties.

When you need options that the `` and `` components do not currently support, you can use the `getImage()` function to create a custom component. 
...
5. Import and use `` in any `.astro` file. Be sure to pass the necessary props for generating two different images at the different viewport sizes:
