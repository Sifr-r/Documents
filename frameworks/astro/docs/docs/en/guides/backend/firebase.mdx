...
## Initializing Firebase in Astro (part 2)
...
## Adding authentication with Firebase (part 2)
...
## Adding authentication with Firebase (part 3)
...
## Adding authentication with Firebase (part 4)
...
## Connecting to Firestore database (part 2)
...
## Connecting to Firestore database (part 3)
...
## Connecting to Firestore database (part 4)
