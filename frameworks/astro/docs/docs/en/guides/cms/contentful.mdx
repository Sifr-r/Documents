...
## Making a blog with Astro and Contentful (part 2)
...
```astro title="src/pages/index.astro" ins={19-37}
---
import { contentfulClient } from "../lib/contentful";
import type { BlogPost } from "../lib/contentful";
...
## Making a blog with Astro and Contentful (part 3)
...
## Making a blog with Astro and Contentful (part 4)
...
## Making a blog with Astro and Contentful (part 5)
