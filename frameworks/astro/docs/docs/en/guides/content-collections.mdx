...
## What are Content Collections? (part 2)
...
## What are Content Collections? (part 3)
...
## Build-time collection loaders (part 2)
...
## Build-time collection loaders (part 3)
...
## Defining the collection schema (part 2)
...
When working with MDX entries, you can also [pass your own components to ``](/en/guides/integrations-guide/mdx/#passing-components-to-mdx-content) to replace HTML elements with custom alternatives.

#### Passing content as props

A component can also pass an entire collection entry as a prop.

## Querying build-time collections (part 2)
...
## Querying build-time collections (part 3)
...
## Generating Routes from Content (part 2)
...
## Live content collections (part 2)
...
## Live content collections (part 3)
...
## Live content collections (part 4)
