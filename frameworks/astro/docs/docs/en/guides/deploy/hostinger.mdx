...
This guide covers deploying both static and server-rendered Astro projects to Hostinger using [hPanel](https://www.hostinger.com/support/1583483-comprehensive-guide-to-hpanel-at-hostinger/).
...
See the [Node.js adapter guide](/en/guides/integrations-guide/node/) for additional configuration options.
