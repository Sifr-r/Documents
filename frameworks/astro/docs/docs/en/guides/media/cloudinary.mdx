...
Add images in `.astro` components by passing image data (e.g. `src`, `width`, `alt`) to the `` component. This will automatically optimize your image and give you access to the Transformations API.
...
See [Cloudinary's `` documentation](https://astro.cloudinary.dev/cldimage/basic-usage) for more information.

## Using Cloudinary videos

To add video to your `.astro` components,  add the ``  and pass the appropriate properties. This component will automatically optimize and embed your video using the [Cloudinary Video Player](https://cloudinary.com/documentation/cloudinary_video_player).
...
See [Cloudinary's `` documentation](https://astro.cloudinary.dev/cldvideoplayer/basic-usage) for more information.

## Enabling Cloudinary uploads

To enable file uploading in your website or app's UI, add the `` which will embed the [Cloudinary Upload Widget](https://cloudinary.com/documentation/upload_widget).
...
See [Cloudinary's `` documentation](https://astro.cloudinary.dev/clduploadwidget/basic-usage) for more information.
...
export const collections = {
  assets: defineCollection({
    loader: cldAssetsLoader({
      folder: '' // Optional, without loads root directory
    })
  }),
}
```
