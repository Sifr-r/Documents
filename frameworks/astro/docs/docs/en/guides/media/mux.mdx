...
- a React component (`` from `@mux/mux-player-react`)
- an HTML web embed (`<iframe>`)

### Play a video from Mux

Import and use the native `` Astro component directly in your `.astro` files like any other Astro component. 
...
[Mux Uploader](https://www.mux.com/docs/guides/mux-uploader?utm_campaign=21819274-Astro&utm_source=astro-docs) is a fully-functional, customizable video upload UI for your Astro website. The native Astro `` component allows you to build video upload functionality into your web app.
