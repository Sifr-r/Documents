...
## Convert your Next.js Project (part 2)
...
2. Change any [Next or JSX syntax to Astro](#reference-convert-nextjs-syntax-to-astro) or to HTML web standards. This includes ``, ``, `{children}`, and `className`, for example.
...
## Convert your Next.js Project (part 3)
...
## Convert your Next.js Project (part 4)
...
Convert any Next `<Link to="">`, `` etc. components to HTML `<a href="">` tags. 
...
## Reference: Convert Next.js Syntax to Astro (part 2)
...
Convert any Next `` components to [Astro's own image component](/en/guides/images/) in `.astro` or `.mdx` files, or to a [standard HTML `<img>` / JSX `<img />`](/en/guides/images/#images-in-ui-framework-components) tag as appropriate in your React components. 
