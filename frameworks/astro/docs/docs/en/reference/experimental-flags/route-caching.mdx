...
## Writing a custom cache provider (part 2)

**Type:** `(context: { request: Request; url: URL; waitUntil?: (promise: Promise<unknown>) => void }, next: MiddlewareNext) => Promise`
