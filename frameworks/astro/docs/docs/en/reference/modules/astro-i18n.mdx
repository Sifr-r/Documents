...
## Imports from astro:i18n (part 2)
...
**Type:** `(context: APIContext, statusCode?: ValidRedirectStatus) => Promise`<br />
<Since v="4.6.0" />
</p>
...
**Type:** `(context: APIContext, response: Response) => Promise`<br />
<Since v="4.6.0" />
</p>
...
**Type:** `(context: APIContext, response?: Response) => Promise | undefined`<br />
<Since v="4.6.0" />
</p>
...
## Imports from astro:i18n (part 3)
...
## Imports from astro:i18n (part 4)
