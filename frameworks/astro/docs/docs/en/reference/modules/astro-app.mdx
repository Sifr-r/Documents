...
## Imports from astro/app/entrypoint (part 2)
...
**Type:** `(source: Response, destination: ServerResponse) => Promise<ServerResponse | undefined>`<br />
<Since v="6.0.0" />
</p>
...
**Type:** `{addCookieHeader?: boolean; clientAddress?: string; locals?: object; prerenderedErrorPageFetch?: (url: ErrorPagePath) => Promise; waitUntil?: (promise: Promise<unknown>) => void; routeData?: RouteData;}`
</p>
...
**Type:** `(url: ErrorPagePath) => Promise`<br />
**Default:** `fetch`<br />
<Since v="5.6.0" />
</p>
