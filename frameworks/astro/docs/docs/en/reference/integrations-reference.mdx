...
**Type:** `(event: string, callback: (data: T) => void) => void`<br />
</p>
...
**Type:** `(event: string, payload: T) => void`<br />
</p>
...
**Type:** <code>Map\<string, <a href="#the-pagebuilddata-object">PageBuildData</a>\></code>
</p>
...
**Type:** <code>\{ onRequest?: <a href="/en/reference/modules/astro-middleware/#middlewarehandler">MiddlewareHandler</a>; \}</code>
</p>
...
## Integration types reference (part 2)
...
**Type:** <code>() => Promise\<Array\<\{ pathname: string; route: <a href="#routedata">RouteData</a>; \}\>\></code>
</p>
...
## Integration types reference (part 3)
...
**Type:** `IntegrationResolvedRoute[]`<br />
<Since v="6.1.0" />
</p>
...
## Integration types reference (part 4)
...
## Integration types reference (part 5)
...
## Integration types reference (part 6)
...
**Type:** [`AstroConfig['trailingSlash']`](/en/reference/configuration-reference/#trailingslash)<br />
<Since v="3.5.4" />
</p>
...
**Type:** [`NonNullable<AstroConfig['build']>['format']`](/en/reference/configuration-reference/#buildformat)<br />
<Since v="4.2.2" />
</p>
...
## Integration types reference (part 7)
...
**Type:** [`MiddlewareHandler`](/en/reference/modules/astro-middleware/#middlewarehandler)<br />
<Since v="3.0.3" />
</p>
...
**Type:** `() => Promise | ServerIslandMappings`<br />
<Since v="6.0.0" />
</p>
...
## Integration types reference (part 8)
...
**Type:** <code>() => Promise\<\{ server: Record\<string, <a href="/en/reference/modules/astro-actions/#actionclient">ActionClient</a>\>; \}\> | \{ server: Record\<string, <a href="/en/reference/modules/astro-actions/#actionclient">ActionClient</a>\>; \}</code><br />
<Since v="5.4.2" />
</p>
...
**Type:** `() => Promise<{ default: SessionDriverFactory | null }>`<br />
<Since v="6.0.0" />
</p>
...
**Type:** <code>Partial\<<a href="/en/reference/modules/astro-assets/#remotepattern">RemotePattern</a>\>[]</code>
</p>
...
**Type:** <code><a href="/en/reference/configuration-reference/#session-options">SessionConfig\<TDriver\></a> & \{ driverModule?: () => Promise\<\{ default: () => unstorage.Driver \}\>; }</code><br />
<Since v="5.1.0" />
</p>
...
## Integration types reference (part 9)
...
**Type:** `{ enabled: boolean; latestAstroVersion: string | undefined; debugInfoOutput: string | undefined; }`<br />
<Since v="6.0.0" />
</p>
...
## Integration types reference (part 10)
...
**Type:** `"error" | "warn" | "debug" | "info" | "silent"`<br />
<Since v="6.0.0" />
</p>
