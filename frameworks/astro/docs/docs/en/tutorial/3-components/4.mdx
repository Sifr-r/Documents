...
Create a `` component to open and close your mobile menu.
...
3. Place this new `` component just before your `` component in `Header.astro`. 
...
## Write your first script tag (part 2)
