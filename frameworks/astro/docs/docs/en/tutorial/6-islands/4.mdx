...
3. Render your post `` within the layout for Markdown pages. This allows you to specify a common layout for all of your posts.
...
## Replace import.meta.glob() with getCollection() (part 2)
