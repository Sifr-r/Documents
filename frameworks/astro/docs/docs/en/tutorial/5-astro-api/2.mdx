...
4. You can even refactor this to use your `` component instead! (Don't forget to import this component at the top of `[tag].astro`.)
...
1. The `import.meta.glob()` call to receive information about all your `.md` files to pass to each page route.
    ...
    <Option isCorrect>inside `getStaticPaths`
...
## Use props in dynamic routes (part 2)

inside `getStaticPaths`
    <Option isCorrect>outside `getStaticPaths`
...
## Advanced JavaScript: Generate pages from existing tags (part 2)
...
1. A function that returns an array of page routes.
      ...
      params
      dynamic routing
      <Option isCorrect>`getStaticPaths()`
      props
...
2. The process of creating multiple page routes from one file in Astro.
      ...
      params
      <Option isCorrect>dynamic routing
      `getStaticPaths()`
      props

## Advanced JavaScript: Generate pages from existing tags (part 3)

4. A value that defines the name of a page route generated dynamically.

    
      <Option isCorrect>params
      dynamic routing
      `getStaticPaths()`
      props
