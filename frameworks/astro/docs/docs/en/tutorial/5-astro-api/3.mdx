...
## Challenge: Include tags in your blog post layout (part 2)
...
1. `src/pages/categories.astro`
      ...
      <Option isCorrect>`src/pages/categories/index.astro`
...
2. `src/pages/posts.astro`
      ...
      `src/pages/posts/post.astro`
      <Option isCorrect>`src/pages/posts/index.astro`
...
3. `src/pages/products/shoes/index.astro`
      ...
      <Option isCorrect>`src/pages/products/shoes.astro`
      `src/pages/posts/post.astro`
      `src/pages/posts/index.astro`
      `src/components/shoes/Shoe.astro`
