...
Add interactive elements such as buttons adjacent to the disclosure heading by wrapping them in a `<div>`. `` and `` must not have interactive children.
...
<Disclosure style={{width: 200}}>
  <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
    {/*- begin highlight -*/}
    <DisclosureHeader style={{flex: 1}}>Files
...
| `className` | `ClassNameOrFunction | undefined` | 'react-aria-Disclosure' | The CSS [className](https://developer.mozilla.org/en-US/docs/Web/API/Element/className) for the element. A function may be provided to compute the class based on component state. |
...
| `className` | `ClassNameOrFunction | undefined` | 'react-aria-DisclosurePanel' | The CSS [className](https://developer.mozilla.org/en-US/docs/Web/API/Element/className) for the element. A function may be provided to compute the class based on component state. |
| `dir` | `string | undefined` | — |  |
| `hidden` | `boolean | undefined` | — |  |
