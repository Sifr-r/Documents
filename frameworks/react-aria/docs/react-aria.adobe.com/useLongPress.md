...
<InlineAlert variant="notice">
  Accessibility
  This example does not have a keyboard accessible way to trigger the long press action. Because the method of triggering
...
|------|------|-------------|
| `longPressProps` \* | `DOMAttributes` | Props to spread on the target element. |
