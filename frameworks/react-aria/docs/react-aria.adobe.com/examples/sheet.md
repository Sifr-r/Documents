...
An iOS-style gesture driven sheet built with React Aria Components, [Motion](https://motion.dev/), and [Tailwind CSS](https://tailwindcss.com/).
...
import {Dialog, ModalOverlay, Modal, Button, Heading} from 'react-aria-components/Modal';
