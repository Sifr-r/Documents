...
A re-creation of the iOS List View built with React Aria Components, [Motion](https://motion.dev/), and [Tailwind CSS](https://tailwindcss.com/) with support for swipe gestures, layout animations, and multiple selection mode.

```tsx
import type {Selection, SelectionMode} from 'react-aria-components/GridList';
import type {CSSProperties} from 'react';
import {Button, GridListItem, GridList} from 'react-aria-components/GridList';
