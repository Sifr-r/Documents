...
<Tabs
  ...
  density="compact"
>
  <Tab id="cursor">Cursor<Tab id="vscode">VS Code<Tab id="claude-desktop">Claude Code (Desktop)<Tab id="claude-code">Claude Code (CLI)<Tab id="codex">Codex<Tab id="gemini-cli">Gemini CLI<Tab id="other">Other
