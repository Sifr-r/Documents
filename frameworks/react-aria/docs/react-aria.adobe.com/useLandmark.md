...
Pressing F6 will move focus to the next landmark on the page, and pressing Shift+F6 will move focus to the previous landmark.
...
Alt+F6 will always move focus to the main landmark if it has been registered.
