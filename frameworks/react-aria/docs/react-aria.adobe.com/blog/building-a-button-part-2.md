...
## JavaScript hover interactions (part 2)
...
As we've seen, cross-device interactions are difficult to handle across so many different types of devices. Even "simple" components like buttons are much more complicated than they seem at first. If you're building your own button component, I'd recommend checking out the [useButton](../Button/useButton.md) and [useHover](../useHover.md) hooks, which will help ensure that everything works as expected across a wide variety of devices.
