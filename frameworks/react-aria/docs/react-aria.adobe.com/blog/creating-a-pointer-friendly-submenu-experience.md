...
<SubmenuSafeArea
  role="img"
  aria-label="Safe area triangle drawn between pointer and submenu"
/>
...
<SubmenuAtan2
  role="img"
  aria-label="atan2 value as angle between the X axis and some line on a cartesian plane"
/>
...
<SubmenuAtan2FromPointer
  role="img"
  aria-label="Triangles formed between pointer and various points on submenu"
/>
