  ...
  return (
    <>
      <CheckboxGroup
        ...
        {/*- end highlight -*/}
        <Checkbox value="soccer">Soccer
        <Checkbox value="baseball">Baseball
        <Checkbox value="basketball">Basketball
...
Use the `name` prop to submit the selected checkboxes to the server. Set the `isRequired` prop on the `` to validate the user selects at least one checkbox, or on individual checkboxes. See the [Forms](forms.md) guide to learn more.
...
import {Form} from 'vanilla-starter/Form';;
  ...
  <div style={{display: 'flex', gap: 32, flexWrap: 'wrap'}}>
    <CheckboxGroup
      ...
      isRequired>
      {/*- end highlight -*/}
      <Checkbox value="lettuce">Lettuce
      <Checkbox value="tomato">Tomato
      <Checkbox value="onion">Onion
      <Checkbox value="sprouts">Sprouts
    
    <CheckboxGroup label="Agree to the following" name="terms">
      {/*- begin highlight -*/}
      <Checkbox value="terms" isRequired>Terms and conditions
      <Checkbox value="privacy" isRequired>Privacy policy
      <Checkbox value="cookies" isRequired>Cookie policy
      {/*- end highlight -*/}
