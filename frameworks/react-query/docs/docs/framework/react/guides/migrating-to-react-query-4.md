...
import { MyComponentDataProvider, useItems } from "@my-scope/my-component-data";
 ...
 // <-- Provides container data (like "user") using its own React Query provider
  ...
   // <-- Provides app data using its own React Query provider (unused in this example)
    ...
       // <-- Provides component data (like "items") using its own React Query provider
