...
```ts
function mockClear(): MockInstance
```
...
```ts
function mockName(name: string): MockInstance
```
...
```ts
function mockImplementation(fn: T): MockInstance
```
...
```ts
function mockImplementationOnce(fn: T): MockInstance
```
...
```ts
function mockRejectedValue(value: unknown): MockInstance
```
...
```ts
function mockRejectedValueOnce(value: unknown): MockInstance
```
...
```ts
function mockReset(): MockInstance
```
...
```ts
function mockRestore(): MockInstance
```
...
```ts
function mockResolvedValue(value: Awaited<ReturnType>): MockInstance
```
...
```ts
function mockResolvedValueOnce(value: Awaited<ReturnType>): MockInstance
```
...
```ts
function mockReturnThis(): MockInstance
```
...
```ts
function mockReturnValue(value: ReturnType): MockInstance
```
...
```ts
function mockReturnValueOnce(value: ReturnType): MockInstance
```
...
```ts
const lastCall: Parameters | undefined
```
...
const results: MockResult<ReturnType>[]
```
...
const settledResults: MockSettledResult<Awaited<ReturnType>>[]
```
...
```ts
const contexts: ThisParameterType[]
```
