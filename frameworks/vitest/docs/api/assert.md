...
- **Type:**
  ...
  - `(haystack: readonly T[] | ReadonlySet | ReadonlyMap<any, T>, needle: T, message?: string) => void`
  - `<T extends object>(haystack: WeakSet, needle: T, message?: string) => void`
...
- `(haystack: string, needle: string, message?: string) => void`
- `(haystack: readonly T[] | ReadonlySet | ReadonlyMap<any, T>, needle: T, message?: string) => void`
- `(haystack: T, needle: T extends WeakSet<any> ? never : Partial, message?: string) => void`
...
- **Type:** `(object: T, keys: Array<Object | string> | { [key: string]: any }, message?: string) => void`
