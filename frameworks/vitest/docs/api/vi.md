...
- **Type**: `(path: Promise, factory?: MockOptions | ((importOriginal: () => T) => T | Promise)) => void`
...
- **Type**: `(obj: T, deep?: boolean) => MaybeMockedDeep`
- **Type**: `(obj: T, options?: { partial?: boolean; deep?: boolean }) => MaybePartiallyMockedDeep`
...
## Mocking Functions and Objects (part 2)
...
## Mocking Functions and Objects (part 3)
...
- **Type:** `(callback: WaitForCallback, options?: number | WaitForOptions) => Promise`
...
- **Type:** `(callback: WaitUntilCallback, options?: number | WaitUntilOptions) => Promise`
