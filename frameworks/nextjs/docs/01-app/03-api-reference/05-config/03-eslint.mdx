...
|      <Check size={18} />      | [@next/next/no-duplicate-head](/docs/messages/no-duplicate-head)                                                         | Prevent duplicate usage of `` in `pages/_document.js`.                                                     |
...
## Disabling linting during production builds (part 2)
