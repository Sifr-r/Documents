...
## Generate images using code (.js, .ts, .tsx) (part 2)
...
## Generate images using code (.js, .ts, .tsx) (part 3)
...
## Generate images using code (.js, .ts, .tsx) (part 4)
...
## Generate images using code (.js, .ts, .tsx) (part 5)
