...
The `useLinkStatus` hook lets you tracks the **pending** state of a ``. You can use it to show inline visual feedback to the user (like spinners or text glimmers) while a navigation to a new route completes.
