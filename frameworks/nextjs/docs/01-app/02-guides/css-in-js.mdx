...
export default function StyledJsxRegistry({
  ...
  return <StyleRegistry registry={jsxStyleRegistry}>{children}
}
```
...
## Configuring CSS-in-JS in app (part 2)
...
## Configuring CSS-in-JS in app (part 3)
...
## Configuring CSS-in-JS in app (part 4)
