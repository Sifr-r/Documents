...
If you would like to add additional configuration options, you can include it within the `` component used in a [custom `_document.js`](/docs/pages/building-your-application/routing/custom-document):
