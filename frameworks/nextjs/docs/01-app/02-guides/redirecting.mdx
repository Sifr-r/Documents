...
> **Good to know**:
>
> - If you don't need to programmatically navigate a user, you should use a [``](/docs/app/api-reference/components/link) component.
...
## Managing redirects at scale (advanced) (part 2)
...
## Managing redirects at scale (advanced) (part 3)
