...
## Example accessibility tests (part 2)
...
public class HomepageTests {
  ...
  shouldOnlyHaveAccessibilityViolationsMatchingKnownFingerprints() throws Exception {
    ...
    List violationFingerprints = fingerprintsFromScanResults(accessibilityScanResults);

## Handling known issues (part 2)
...
assertEquals(Arrays.asList(
  ...
  public List fingerprintsFromScanResults(AxeResults results) {
