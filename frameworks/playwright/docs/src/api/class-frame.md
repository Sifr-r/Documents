...
## async method: Frame.dispatchEvent (part 2)
...
## async method: Frame.evaluate (part 2)
...
## async method: Frame.evaluateHandle (part 2)
...
## async method: Frame.selectOption (part 2)
...
## async method: Frame.waitForFunction (part 2)
...
## async method: Frame.waitForSelector (part 2)
