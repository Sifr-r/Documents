...
## async method: Page.dispatchEvent (part 2)
...
## async method: Page.emulateMedia (part 2)
...
## async method: Page.emulateMedia (part 3)
...
## async method: Page.evaluate (part 2)
...
## async method: Page.evaluateHandle (part 2)
...
## async method: Page.exposeBinding (part 2)
...
## async method: Page.exposeFunction (part 2)
...
## async method: Page.press (part 2)
...
## async method: Page.addLocatorHandler (part 2)
...
## async method: Page.addLocatorHandler (part 3)
...
## async method: Page.addLocatorHandler (part 4)
...
## async method: Page.route (part 2)
...
## async method: Page.selectOption (part 2)
...
## async method: Page.waitForFunction (part 2)
...
## async method: Page.waitForSelector (part 2)
