...
## , the FastAPI of CLIs { #typer-the-fastapi-of-clis }
...
## Example upgrade { #example-upgrade } (part 2)
...
## Example upgrade { #example-upgrade } (part 3)
