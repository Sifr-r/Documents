...
## Dependencies with yield, HTTPException, except and Background Tasks { #dependencies-with-yield-httpexception-except-and-background-tasks } (part 2)
...
## Dependencies with yield, HTTPException, except and Background Tasks { #dependencies-with-yield-httpexception-except-and-background-tasks } (part 3)
