...
## Proxy Forwarded Headers { #proxy-forwarded-headers } (part 2)
...
## Proxy with a stripped path prefix { #proxy-with-a-stripped-path-prefix } (part 2)
...
## Testing locally with Traefik { #testing-locally-with-traefik } (part 2)
