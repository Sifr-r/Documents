...
## Asynchronous Code { #asynchronous-code } (part 2)
...
## Asynchronous Code { #asynchronous-code } (part 3)
...
## Asynchronous Code { #asynchronous-code } (part 4)
...
## Asynchronous Code { #asynchronous-code } (part 5)
...
## async and await { #async-and-await } (part 2)
