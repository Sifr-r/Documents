...
export class User {
  ...
  profile: Relation; // <--- see "Relation<>" type here instead of just "Profile"
}
```
 ...
 */
export type WrapperType = T; // WrapperType === Relation
```
...
export class UsersService {
  constructor(
    ...
    private readonly profileService: WrapperType,
  ) {};
}
```
