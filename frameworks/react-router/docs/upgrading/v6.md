...
Split any multi-segment splat `` into a parent route with the path and a child route with the splat:
...
## Update to latest v6.x (part 2)

<docs-warning>If you are not using a `` you can skip this</docs-warning>
