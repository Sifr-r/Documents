...
When you have a [`pages/`](/docs/3.x/directory-structure/pages) directory, you need to use the [``](/docs/3.x/api/components/nuxt-page) component to display the current page:
...
When your application requires different layouts for different pages, you can use the `layouts/` directory with the [``](/docs/3.x/api/components/nuxt-layout) component. This allows you to define multiple layouts and apply them per page.
