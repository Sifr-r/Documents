...
## addComponentsDir (part 3)

| `island`          | `boolean`                                                                                | `false`  | If enabled, registers components as islands. You can read more about islands in [``](/docs/3.x/api/components/nuxt-island) component description.                                                                                          |
...
| `island`          | `boolean`                                  | `false`  | If enabled, registers component as island. You can read more about islands in [``](/docs/3.x/api/components/nuxt-island) component description.                                                                                            |
