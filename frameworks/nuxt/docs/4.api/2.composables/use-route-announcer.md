...
A composable which observes the page title changes and updates the announcer message accordingly. Used by [``](/docs/3.x/api/components/nuxt-route-announcer) and controllable.
