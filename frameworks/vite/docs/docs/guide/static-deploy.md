...
1. Set the correct `base` in `vite.config.js`.
   ...
   If you are deploying to `https://<USERNAME or GROUP>.gitlab.io//`, for example your repository is at `https://gitlab.com//`, then set `base` to `'//'`.
...
5. Click **Create Static Site**. Your app should be deployed at `https://.onrender.com/`.
