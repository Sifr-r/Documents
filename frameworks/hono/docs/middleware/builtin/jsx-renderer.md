...
As a concrete example, you can use this to disable streaming when generating static sites (SSG) with ``, by using the [`isSSGContext`](/docs/helpers/ssg#isssgcontext) helper:
