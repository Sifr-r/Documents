# get-thread-state-at-checkpoint-1

## OpenAPI

````yaml /langsmith/agent-server-openapi.json post /threads/{thread_id}/state/checkpoint
openapi: 3.1.0
info:
...
paths:
  /threads/{thread_id}/state/checkpoint:
    post:
      ...
      operationId: >-
        post_thread_state_at_checkpoint_threads__thread_id__state__checkpoint_id__get
      parameters:
