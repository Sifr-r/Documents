...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/sso/email-verification/status
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/sso/email-verification/status:
    post:
      ...
      operationId: >-
        check_sso_email_verification_status_api_v1_sso_email_verification_status_post
      requestBody:
        content:
          application/json:
            schema:
