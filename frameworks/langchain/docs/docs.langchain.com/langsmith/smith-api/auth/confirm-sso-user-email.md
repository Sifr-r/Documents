...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/sso/email-verification/confirm
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                type: object
                title: >-
                  Response Confirm Sso User Email Api V1 Sso Email Verification
                  Confirm Post
        '422':
