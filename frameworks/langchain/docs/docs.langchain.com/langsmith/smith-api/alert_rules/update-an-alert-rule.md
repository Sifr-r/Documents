...
````yaml /langsmith/langsmith-platform-openapi.json patch /v1/platform/alerts/{session_id}/{alert_rule_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
tags:
  ...
  - name: skills
    x-hidden: true
paths:
  /v1/platform/alerts/{session_id}/{alert_rule_id}:
    patch:
      tags:
        - alert_rules
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/alerts.UpdateAlertRuleRequest'
      responses:
        '200':
