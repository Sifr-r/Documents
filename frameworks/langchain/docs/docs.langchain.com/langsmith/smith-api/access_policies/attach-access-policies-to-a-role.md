...
````yaml /langsmith/langsmith-platform-openapi.json post /v1/platform/orgs/current/access-policies/roles/{role_id}/access-policies
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /v1/platform/orgs/current/access-policies/roles/{role_id}/access-policies:
    post:
      ...
      description: >-
        ...
        body must contain an array of access policy IDs.
      parameters:
        - description: Role ID
          name: role_id
          in: path
