...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/annotation-queues/{queue_id}/runs/resolve/{queue_run_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/annotation-queues/{queue_id}/runs/resolve/{queue_run_id}:
    get:
      ...
      operationId: >-
        resolve_annotation_queue_run_api_v1_annotation_queues__queue_id__runs_resolve__queue_run_id__get
      parameters:
        - name: queue_id
          in: path
          required: true
  ...
  schemas:
    ResolvedAnnotationQueueRunSchema:
      ...
      required:
        - section
        - position
      title: ResolvedAnnotationQueueRunSchema
      description: Resolved annotation queue run position for deep linking.
    HTTPValidationError:
      properties:
        detail:
          items:
