...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/annotation-queues/{queue_id}/total_size
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/annotation-queues/{queue_id}/total_size:
    get:
      ...
      operationId: >-
        get_total_size_from_annotation_queue_api_v1_annotation_queues__queue_id__total_size_get
      parameters:
        - name: queue_id
          in: path
          required: true
