...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/annotation-queues/{queue_id}/runs/delete
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/annotation-queues/{queue_id}/runs/delete:
    post:
      ...
      operationId: >-
        delete_runs_from_annotation_queue_api_v1_annotation_queues__queue_id__runs_delete_post
      parameters:
        - name: queue_id
          in: path
          required: true
