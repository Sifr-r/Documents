...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/annotation-queues/status/{annotation_queue_run_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/annotation-queues/status/{annotation_queue_run_id}:
    post:
      ...
      operationId: >-
        create_identity_annotation_queue_run_status_api_v1_annotation_queues_status__annotation_queue_run_id__post
      parameters:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/IdentityAnnotationQueueRunStatusCreateSchema
      responses:
        '200':
