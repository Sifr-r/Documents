...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/annotation-queues/{queue_id}/runs/{queue_run_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/annotation-queues/{queue_id}/runs/{queue_run_id}:
    delete:
      ...
      operationId: >-
        delete_run_from_annotation_queue_api_v1_annotation_queues__queue_id__runs__queue_run_id__delete
      parameters:
        - name: queue_id
          in: path
          required: true
