...
In the **hybrid** model, you self-host your <Tooltip tip="The server that runs your applications.">Agent Servers in your own infrastructure and send traces to LangSmith, where LangSmith can be either a self-hosted instance or LangSmith SaaS.
...
| ------------------------------------------------------------------------------ | ----------------------------------------------------- | ------------------------------------- |
| <Tooltip tip="The server that runs your applications.">Agent Servers | Your infrastructure                                   | You                                   |
