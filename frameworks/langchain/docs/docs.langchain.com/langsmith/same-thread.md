...
You'll see that the second agent will respond using information from the [checkpoint](/oss/python/langgraph/persistence#checkpoints) generated in the thread by the first agent as context.
...
## Run assistants on thread (part 2)
...
## Run assistants on thread (part 3)
