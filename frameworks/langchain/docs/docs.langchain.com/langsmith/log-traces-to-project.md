...
## Set the destination project dynamically (part 2)
...
## Set the destination project dynamically (part 3)
...
## Set the destination workspace dynamically (part 2)
...
## Set the destination workspace dynamically (part 3)
...
## Set the destination workspace dynamically (part 4)
...
## Write traces to multiple destinations with replicas (part 2)
...
## Write traces to multiple destinations with replicas (part 3)
...
## Write traces to multiple destinations with replicas (part 4)
