...
## With client secret (Recommended) (part 2)
...
## With client secret (Recommended) (part 3)
...
## With client secret (Recommended) (part 4)
...
## With client secret (Recommended) (part 5)

For details on SCIM setup, refer to [Set up SCIM for your organization](/langsmith/user-management#set-up-scim-for-your-organization).
...
## With client secret (Recommended) (part 6)
