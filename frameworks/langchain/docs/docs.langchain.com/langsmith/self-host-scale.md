...
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------- | :--------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Tooltip tip="Number of users actively viewing traces on the frontend">Concurrent frontend users                                                       | 5                                                    | 5                                                    | 50                                                                                                                                                                                                                                       | 20                                                   | 50                                                                                                                                                                                                                                       |
| <Tooltip tip="Number of traces being ingested via SDKs or API endpoints">Traces submitted per second                                                   | 10                                                   | 1000                                                 | 10                                                                                                                                                                                                                                       | 100                                                  | 1000                                                                                                                                                                                                                                     |
...
| **ClickHouse setup**                                                                                                                                             | Single instance                                      | Single instance                                      | 3-node <Tooltip tip="Recommended for high read loads to prevent degraded performance. Another option would be [managed clickhouse](/langsmith/self-host-external-clickhouse#langsmith-managed-clickhouse).">replicated cluster | Single instance                                      | 3-node <Tooltip tip="Recommended for high read loads to prevent degraded performance. Another option would be [managed clickhouse](/langsmith/self-host-external-clickhouse#langsmith-managed-clickhouse).">replicated cluster |
| <Tooltip tip="We recommend using an external instance and enabling autoexpansion for the disk to handle growing data requirements.">Postgres resources | 2 CPU<br />8 GB memory<br />10 GB storage (external) | 2 CPU<br />8 GB memory<br />10 GB storage (external) | 2 CPU<br />8 GB memory<br />10 GB storage (external)                                                                                                                                                                                     | 2 CPU<br />8 GB memory<br />10 GB storage (external) | 2 CPU<br />8 GB memory<br />10 GB storage (external)                                                                                                                                                                                     |
...
## Example LangSmith configurations for scale (part 2)
...
redis:
  ...
  # external:
  #   enabled: true
  #   connectionUrl: "" OR existingSecretName: "<SECRET-NAME>"

## Example LangSmith configurations for scale (part 3)
...
## Example LangSmith configurations for scale (part 4)
