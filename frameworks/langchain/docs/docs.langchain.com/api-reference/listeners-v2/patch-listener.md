...
````yaml https://api.host.langchain.com/openapi.json patch /v2/listeners/{listener_id}
openapi: 3.1.0
info:
...
paths:
  /v2/listeners/{listener_id}:
    patch:
      tags:
        - Listeners (v2)
      summary: Patch Listener
      description: Patch a listener by ID.
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/ListenerPatchRequest'
      responses:
        '200':
      ...
      properties:
        ...
        compute_config:
          anyOf:
            ...
            - type: 'null'
      type: object
      title: ListenerPatchRequest
      description: Requst body for patching a listener.
    Listener:
      properties:
        version:
          anyOf:
