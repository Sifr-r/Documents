...
````yaml https://api.host.langchain.com/openapi.json post /v2/auth/agents/{agent_id}/connections
openapi: 3.1.0
info:
    ...
    post:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CreateAgentConnectionRequest'
      responses:
        '201':
...
components:
  schemas:
    CreateAgentConnectionRequest:
      ...
      required:
        - oauth_token_id
      title: CreateAgentConnectionRequest
