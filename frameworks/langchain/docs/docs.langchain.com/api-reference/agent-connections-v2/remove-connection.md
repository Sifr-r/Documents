...
````yaml https://api.host.langchain.com/openapi.json delete /v2/auth/agents/{agent_id}/connections/{connection_id}
openapi: 3.1.0
info:
...
security: []
paths:
  /v2/auth/agents/{agent_id}/connections/{connection_id}:
    delete:
      tags:
        - Agent Connections (v2)
      summary: Remove Connection
      operationId: >-
        remove_connection_v2_auth_agents__agent_id__connections__connection_id__delete
      parameters:
        - name: agent_id
          in: path
          required: true
