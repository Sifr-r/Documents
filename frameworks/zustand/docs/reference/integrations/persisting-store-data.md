...
> Type: `(persistedState: Object, version: number) => Object | Promise`
...
## Hydration and asynchronous storages (part 2)
...
except for writing `create()(...)` instead of `create(...)`.
...
storage: {
    ...
    setItem: (name, newValue: StorageValue) => {
