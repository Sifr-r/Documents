...
If a function throws, it may be due to cancellation (e.g. <CodeStep step={1}>the Database connection has been closed). You can use the <CodeStep step={2}>`aborted` property to check if the error was due to cancellation or a real error. You may want to <CodeStep step={3}>ignore errors that were due to cancellation.
