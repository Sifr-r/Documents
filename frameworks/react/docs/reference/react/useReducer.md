...
1. The <CodeStep step={1}>current state of this state variable, initially set to the <CodeStep step={3}>initial state you provided.
...
React will pass the current state and the action to your <CodeStep step={4}>reducer function. Your reducer will calculate and return the next state. React will store that next state, render your component with it, and update the UI.
