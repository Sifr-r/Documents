...
## Lifting state up by example {//} (part 2)
...
## Lifting state up by example {//} (part 3)
...
## Lifting state up by example {//} (part 4)
...
## A single source of truth for each state {//} (part 2)
...
## A single source of truth for each state {//} (part 3)
