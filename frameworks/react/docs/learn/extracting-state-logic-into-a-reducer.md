...
## Consolidate state logic with a reducer {//} (part 2)
...
## Consolidate state logic with a reducer {//} (part 3)
...
## Consolidate state logic with a reducer {//} (part 4)
...
## Consolidate state logic with a reducer {//} (part 5)
...
## Consolidate state logic with a reducer {//} (part 6)
...
## Consolidate state logic with a reducer {//} (part 7)
...
## Writing concise reducers with Immer {//} (part 2)
...
## Writing concise reducers with Immer {//} (part 3)
...
## Writing concise reducers with Immer {//} (part 4)
...
## Writing concise reducers with Immer {//} (part 5)
...
## Writing concise reducers with Immer {//} (part 6)
...
## Writing concise reducers with Immer {//} (part 7)
...
## Writing concise reducers with Immer {//} (part 8)
...
## Writing concise reducers with Immer {//} (part 9)
...
## Writing concise reducers with Immer {//} (part 10)
...
## Writing concise reducers with Immer {//} (part 11)
...
## Writing concise reducers with Immer {//} (part 12)
...
## Writing concise reducers with Immer {//} (part 13)
