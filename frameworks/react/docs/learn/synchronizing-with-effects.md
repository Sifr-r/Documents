...
## How to handle the Effect firing twice in development? {//} (part 2)
...
## How to handle the Effect firing twice in development? {//} (part 3)
...
## How to handle the Effect firing twice in development? {//} (part 4)
