...
## Choosing between event handlers and Effects {//} (part 2)
...
Props, state, and variables declared inside your component's body are called <CodeStep step={2}>reactive values. In this example, `serverUrl` is not a reactive value, but `roomId` and `message` are. They participate in the rendering data flow:
...
## Reactive values and reactive logic {//} (part 2)
...
## Extracting non-reactive logic out of Effects {//} (part 2)
...
## Extracting non-reactive logic out of Effects {//} (part 3)
...
## Extracting non-reactive logic out of Effects {//} (part 4)
...
## Extracting non-reactive logic out of Effects {//} (part 5)
...
## Extracting non-reactive logic out of Effects {//} (part 6)
...
## Extracting non-reactive logic out of Effects {//} (part 7)
...
## Extracting non-reactive logic out of Effects {//} (part 8)
...
## Extracting non-reactive logic out of Effects {//} (part 9)
...
## Extracting non-reactive logic out of Effects {//} (part 10)
...
## Extracting non-reactive logic out of Effects {//} (part 11)
...
## Extracting non-reactive logic out of Effects {//} (part 12)
...
## Extracting non-reactive logic out of Effects {//} (part 13)
...
## Extracting non-reactive logic out of Effects {//} (part 14)
...
## Extracting non-reactive logic out of Effects {//} (part 15)
