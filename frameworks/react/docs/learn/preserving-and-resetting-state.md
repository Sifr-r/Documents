...
## State is tied to a position in the render tree {//} (part 2)
...
## State is tied to a position in the render tree {//} (part 3)
...
## Same component at the same position preserves state {//} (part 2)
...
In this example, ticking the checkbox will replace `` with a `<p>`:
...
## Different components at the same position reset state {//} (part 2)
...
## Different components at the same position reset state {//} (part 3)
...
## Resetting state at the same position {//} (part 2)
...
## Resetting state at the same position {//} (part 3)
...
## Resetting state at the same position {//} (part 4)
...
## Resetting state at the same position {//} (part 5)
...
## Resetting state at the same position {//} (part 6)
...
## Resetting state at the same position {//} (part 7)
...
## Resetting state at the same position {//} (part 8)
...
## Resetting state at the same position {//} (part 9)
...
## Resetting state at the same position {//} (part 10)
...
## Resetting state at the same position {//} (part 11)
