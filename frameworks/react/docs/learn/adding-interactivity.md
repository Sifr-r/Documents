...
## State: a component's memory {//} (part 2)
...
## State: a component's memory {//} (part 3)
...
## State: a component's memory {//} (part 4)
...
## Updating objects in state {//} (part 2)
...
## Updating arrays in state {//} (part 2)
