...
## Updating the same state multiple times before the next render {//} (part 2)
...
## Updating the same state multiple times before the next render {//} (part 3)
...
## Updating the same state multiple times before the next render {//} (part 4)
...
## Updating the same state multiple times before the next render {//} (part 5)
