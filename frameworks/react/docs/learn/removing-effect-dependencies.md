...
## Dependencies should match the code {//} (part 2)
...
Notice that you can't "choose" the dependencies of your Effect. Every <CodeStep step={2}>reactive value used by your Effect's code must be declared in your dependency list. The dependency list is determined by the surrounding code:
...
## Dependencies should match the code {//} (part 3)
...
## Dependencies should match the code {//} (part 4)
...
## Removing unnecessary dependencies {//} (part 2)
...
## Removing unnecessary dependencies {//} (part 3)
...
## Removing unnecessary dependencies {//} (part 4)
...
## Removing unnecessary dependencies {//} (part 5)
...
## Removing unnecessary dependencies {//} (part 6)
...
## Removing unnecessary dependencies {//} (part 7)
...
## Removing unnecessary dependencies {//} (part 8)
...
## Removing unnecessary dependencies {//} (part 9)
...
## Removing unnecessary dependencies {//} (part 10)
...
## Removing unnecessary dependencies {//} (part 11)
...
## Removing unnecessary dependencies {//} (part 12)
...
## Removing unnecessary dependencies {//} (part 13)
...
## Removing unnecessary dependencies {//} (part 14)
...
## Removing unnecessary dependencies {//} (part 15)
...
## Removing unnecessary dependencies {//} (part 16)
...
## Removing unnecessary dependencies {//} (part 17)
...
## Removing unnecessary dependencies {//} (part 18)
...
## Removing unnecessary dependencies {//} (part 19)
...
## Removing unnecessary dependencies {//} (part 20)
...
## Removing unnecessary dependencies {//} (part 21)
