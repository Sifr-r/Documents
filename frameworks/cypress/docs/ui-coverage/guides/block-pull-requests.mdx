# Block pull requests and set policies | Cypress UI Coverage Documentation
...
## Comparing against a baseline {#comparing-against-a-baseline} (part 4)
...
## Comparing against a baseline {#comparing-against-a-baseline} (part 5)
