# Component Testing in Cypress | Cypress Documentation
...
| [Svelte with Vite](/app/component-testing/svelte/overview#Svelte-with-Vite) <Badge type="info">Alpha       | Svelte 5      | Vite 5-8  |
| [Svelte with Webpack](/app/component-testing/svelte/overview#Svelte-with-Webpack) <Badge type="info">Alpha | Svelte 5      | Webpack 5 |

The following integrations are built and maintained by Cypress community members.

| Framework                                                                               | UI Library | Bundler |
| --------------------------------------------------------------------------------------- | ---------- | ------- |
| [Qwik](https://github.com/qwikifiers/cypress-qwik) <Badge type="info">Community | Qwik       | Vite    |
| [Lit](https://github.com/redfox-mx/cypress-lit) <Badge type="info">Community    | Lit        | Vite    |
...
## Configuring Component Testing (part 2)
...
## Writing Your First Test (part 2)
