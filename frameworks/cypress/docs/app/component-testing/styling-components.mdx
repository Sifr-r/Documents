# Test your component's styles | Cypress Documentation
...
root-level component (such as an ``) or a top-level selector with style
...
## Rules for Setting Up Your Styles (part 2)
...
2. The `` component provides its own styles
