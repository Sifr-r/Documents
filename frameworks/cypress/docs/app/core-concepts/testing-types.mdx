...
Cypress is adaptable to many different types of tests outside of end-to-end and component tests, including
[API Testing](/app/get-started/why-cypress#Other), [Visual Testing](/app/tooling/visual-testing), [Unit Testing](/app/references/recipes#Unit-Testing),
[Accessibility Testing](/accessibility/get-started/introduction) and more. Our [plugins](/app/plugins/plugins-list) provide many more tools to help you extensively test your app.
...
| Initialization Command |                 `cy.visit(url)`                  |          `cy.mount()`          |
