...
interactions and generate tests. With a [Cypress Cloud](/cloud/get-started/introduction) account, you also get **Studio AI**—assertion recommendations as you record. Visit our
[guide](/app/guides/cypress-studio) for more information.

## Next steps

- [Test your own app](/app/end-to-end-testing/testing-your-app) — apply what you learned here to a real project.
- [Introduction to Cypress](/app/core-concepts/introduction-to-cypress) — understand how Cypress really works under the hood.
- [Best Practices](/app/core-concepts/best-practices) — learn selector strategies, state management, and patterns for maintainable tests.
- [Cypress AI Skills](/app/tooling/ai-skills) — use your AI coding tool to write, fix, and review Cypress tests with best practices built in.
