...
## Extending TypeScript Support (part 2)
...
Cypress.Commands.add(
  'typeRandomWords',
  { prevSubject: 'element' },
  (subject /* :JQuery */, count = 3, options?) => {
...
Cypress.Commands.overwrite<'type', 'element'>(
  'type',
  (originalFn, element, text, options?: Partial) => {
...
## Extending TypeScript Support (part 3)
...
## Extending TypeScript Support (part 4)
...
## Extending TypeScript Support (part 5)
