# Experimental Features in Cypress: Configuration Options
...
| `experimentalFetchPolyfill`                   | `false` | Automatically replaces `window.fetch` with a polyfill that Cypress can spy on and stub. Note: `experimentalFetchPolyfill` is deprecated and will be removed in a future release. Consider using [cy.intercept()](/api/commands/intercept) to intercept `fetch` requests instead.                                                            |
...
| [`[]`](#Allow-Specific-CSP-Directives) | `experimentalCspAllowList=["default-src","script-src"]` |
...
## Experimental Fast Visibility (part 2)
...
## Experimental Flake Detection Features (part 2)
...
| Version                                      | Changes                                                                                                                                       |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [15.9.0](/app/references/changelog#15-9-0)   | Added component testing support for `experimentalRunAllSpecs`.                                                                                |
