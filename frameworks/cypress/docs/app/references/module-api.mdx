# Module API: How to run Cypress via Node.js
...
| `env`                     | _object_            | Specify secret [environment variables](/app/guides/environment-variables)                                                                                                                                    |
| `expose`                  | _object_            | Specify public [exposed variables](/api/cypress-api/expose)                                                                                                                                                  |
...
| Version                                      | Changes                                                 |
| -------------------------------------------- | ------------------------------------------------------- |
| [15.10.0](/app/references/changelog#15-10-0) | Added `expose` configuration option.                    |
