# Cypress Recipes: How to Test Common Scenarios
...
| Recipe                                                                                            | Description                              |
| ------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| [Visual Testing](/app/tooling/visual-testing)                                                     | Official Cypress guide to visual testing |
| [Code Coverage](/app/tooling/code-coverage)                                                       | Official Cypress guide to code coverage  |
