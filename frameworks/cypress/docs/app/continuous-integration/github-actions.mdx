# Run Cypress tests in GitHub Actions: A Step-by-Step Guide
...
We recommend binding to the action's latest major version by specifying `v7`
...
[Cypress bot PR comments](/cloud/integrations/github#Pull-request-comments).
See
