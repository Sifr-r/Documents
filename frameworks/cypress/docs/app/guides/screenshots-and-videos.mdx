# Capture Screenshots and Videos: Cypress Guide
...
Before `cypress run`, Cypress clears the **entire contents** of the
`screenshotsFolder`—every file and nested subfolder, not just images. If you do
not want to clear your screenshots folder before a run, you can set
[`trashAssetsBeforeRuns`](/app/references/configuration#Screenshots) to `false`.
See the
[`trashAssetsBeforeRuns` notes](/app/references/configuration#trashAssetsBeforeRuns)
for more details.
...
Before `cypress run`, Cypress clears the **entire contents** of the
`videosFolder`—every file and nested subfolder, not just videos. If you do not
want to clear your videos folder before a run, you can set
[`trashAssetsBeforeRuns`](/app/references/configuration#Videos) to `false`. See
the
[`trashAssetsBeforeRuns` notes](/app/references/configuration#trashAssetsBeforeRuns)
for more details.
