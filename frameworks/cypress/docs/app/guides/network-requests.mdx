# Network Requests: Cypress Guide
...
Not sure how to structure intercepts and waits for your specific use case? Use the `/cypress-author` skill with your AI coding tool to generate the right pattern, or `/cypress-explain` to understand why a pattern is used before you change it. See [Cypress AI Skills](/app/tooling/ai-skills).
