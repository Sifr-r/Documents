...
The [experimental test retries](/app/references/experiments#Experimental-Test-Retries) feature offers more options for [detecting flaky tests](/cloud/features/flaky-test-management#Flake-Detection). Experimental retries give you control over the conditions of when a test should have a status of pass or fail.
