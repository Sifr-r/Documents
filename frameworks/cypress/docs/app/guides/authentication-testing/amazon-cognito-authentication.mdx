# Amazon Cognito Authentication: Cypress Guide
...
## Custom Command for Amazon Cognito Authentication (part 2)
...
describe('Cognito, cy.origin() login', function () {
  beforeEach(function () {
    ...
    cy.env(['AWS_COGNITO_USERNAME', 'AWS_COGNITO_PASSWORD']).then(
      ({ username, password }) => {
...
## Custom Command for Amazon Cognito Authentication (part 3)
...
## Custom Command for Amazon Cognito Authentication (part 4)
...
## Custom Command for Amazon Cognito Authentication (part 5)
...
<Icon name="github" inline="true" contentType="rwa" /> is used and provides
...
## Custom Command for Amazon Cognito Authentication (part 6)
