# Okta Authentication: Cypress Guide
...
describe('Okta', function () {
  beforeEach(function () {
    cy.task('db:seed')
    cy.env(['OKTA_USERNAME', 'OKTA_PASSWORD']).then(
      ({ username, password }) => {
...
## Custom Command for Okta Authentication (part 2)
...
## Custom Command for Okta Authentication (part 3)
...
## Custom Command for Okta Authentication (part 4)
...
## Custom Command for Okta Authentication (part 5)
...
## Custom Command for Okta Authentication (part 6)
