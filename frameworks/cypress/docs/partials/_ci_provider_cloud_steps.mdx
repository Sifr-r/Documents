...
1. [Recording test results with the `--record` flag](/cloud/get-started/setup)
   ...
   - [Integrating testing with the pull-request (PR) process](/cloud/integrations/github)
     via
     [commit status check guards](/cloud/integrations/github#Status-checks)
     and convenient
     [test report comments](/cloud/integrations/github#Pull-request-comments).
