...
| [`.end()`](/api/commands/end) <Badge type="caution">deprecated | Explicitly end a chain of Cypress commands.                                                                                                                                     |
...
<a href="/app/plugins/plugins-list#custom-commands">Command Plugins</a> which
you can install or download.
...
| [`Cypress.env`](/api/cypress-api/env) <Badge type="caution">deprecated | Get environment variables from inside your tests.                                                                              |
