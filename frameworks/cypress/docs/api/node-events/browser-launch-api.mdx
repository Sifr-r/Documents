# Browser Launch Event | Cypress Node Events
...
<Icon name="exclamation-triangle" /> This option is not supported when targeting
Electron.
...
[Cypress configuration](/app/references/configuration). The `viewportWidth`
...
[Check out our example recipe showing how to download and validate CSV and Excel files.](/app/references/recipes#Testing-the-DOM)
...
| Version                                  | Changes                                                                                          |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [4.0.0](/app/references/changelog#4-0-0) | New `options` object replaces old `args` as second argument to `before:browser:launch`           |
| [4.0.0](/app/references/changelog#4-0-0) | All Chromium-based browsers, including Electron, have `chromium` set as their `family` property. |
| [4.0.0](/app/references/changelog#4-0-0) | Added `channel` property to browser.                                                             |
