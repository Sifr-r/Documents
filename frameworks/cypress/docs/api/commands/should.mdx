...
as [assertions](/app/core-concepts/introduction-to-cypress#Assertions)
...
- `.should()` will continue to [retry](/app/core-concepts/retry-ability) its
...
| Version                                    | Changes                                         |
| ------------------------------------------ | ----------------------------------------------- |
| [11.0.0](/app/references/changelog#11-0-0) | Throw error if Cypress command used in callback |
| [0.11.4](/app/references/changelog#0-11-4) | Allows callback function argument               |
| [< 0.3.3](/app/references/changelog#0-3-3) | `.should()` command added                       |
