...
| ---------------------------- | --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `action`                     | `'select'`                                                                  | Switches modes. Valid values are `select` and `drag-drop`. See [Action](#Action) below for more details.                                       |
...
| `timeout`                    | [`defaultCommandTimeout`](/app/references/configuration#Timeouts)           | Time to wait for `.selectFile()` to resolve before [timing out](#Timeouts).                                                                    |
...
[subject](/app/core-concepts/introduction-to-cypress#Subject-Management) must
