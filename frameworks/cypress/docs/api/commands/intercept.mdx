...
[Network Requests](/app/guides/network-requests) guide first.
...
| resourceType <Badge type="caution">deprecated | The resource type of the request. See ["Request object properties"](#Request-object-properties) for a list of possible values for `resourceType`. |
...
[alias](/app/core-concepts/variables-and-aliases#Aliases) which can be used
...
[Working with GraphQL](/app/guides/network-requests#Working-with-GraphQL).
...
[#26069](https://github.com/cypress-io/cypress/issues/26069).
...
See also [Controlling the outbound request with `req.continue()`][req-continue]
...
## Glob Pattern Matching URLs (part 2)
...
[Read more about request logging in Cypress.](/app/guides/network-requests#Command-Log)
...
- [Network Requests Guide](/app/guides/network-requests)
