...
1. **Confirm coverage moved the right way.** Review the **Added** and **Modified** tabs, plus any UI Coverage or Cypress Accessibility changes, to verify the PR improved, rather than regressed, quality.
...
| :-----------------------------------: | :-----------------------------------: | ---------------------------------------------------- |
| <Badge type="success">has run | <Badge type="success">has run | Comparison data using both found runs                |
| <Badge type="success">has run |  <Badge type="danger">no run  | Comparison data using last run on feature branch     |
|  <Badge type="danger">no run  | <Badge type="success">has run | Non-comparison data with found feature run           |
|  <Badge type="danger">no run  |  <Badge type="danger">no run  | Non-comparison data using last run on feature branch |
