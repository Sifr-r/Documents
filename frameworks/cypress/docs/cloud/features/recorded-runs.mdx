...
- **Modified** - when the test body has changed from a previously recorded test
...
[test statuses](/app/core-concepts/writing-and-organizing-tests#Test-statuses)
