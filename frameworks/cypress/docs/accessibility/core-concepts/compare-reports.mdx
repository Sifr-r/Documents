# Comparing Accessibility Reports | Cypress Documentation
...
Accessibility reports from different runs can be compared in the [Branch Review](/cloud/features/branch-review#Get-started) area of Cypress Cloud. This allows you to instantly see if any new issues have been introduced, and drill in to see full-page HTML and CSS snapshots showing only the new issues.
...
## Details of each section (part 2)
...
## Ensuring a good comparison (part 2)
