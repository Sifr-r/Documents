# Uniquely identify test elements | Cypress Accessibility
...
Good element identification makes element selectors more readable and meaningful when [reviewing violation details](/accessibility/core-concepts/inspecting-violation-details), and when [creating tickets](/accessibility/core-concepts/inspecting-violation-details#Create-Jira-issue), or having the selectors interpreted by AI tools (see the we [Work with AI agents](/accessibility/work-with-ai-agents))
