# Cypress Rules | Cypress Accessibility Documentation
...
## Interactive elements should be semantically correct (part 2)
...
#### Shadow DOM false positives

There is a known issue related to interactions that take place within some shadow DOM nodes and how they are reported in this rule. If this issue affects your reports, please reach out to your Cypress point-of-contact.
