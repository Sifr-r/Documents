# Accessibility Run-level Reports | Cypress Documentation
...
- **Severity**: The Axe Core® impact level for the rule, or equivalent level for [Cypress rules](/accessibility/core-concepts/cypress-rules).
...
If you have [Cloud MCP](/cloud/integrations/cloud-mcp) configured, your AI agent can query this same data directly—violation counts, failing rules, page and component details, and element-level failures—without leaving your editor.
