# API of results | Cypress Accessibility
...
- The [pull requests and policies guide](/accessibility/block-pull-requests) shows what it looks like to use the Results API to set a policy and fail a pull request.
...
For comprehensive examples of comparing results against a baseline, including complete code examples, baseline structure, and best practices, see the [Block pull requests and set policies](/accessibility/block-pull-requests#comparing-against-a-baseline) guide.
...
## Comparing against a baseline (part 2)
...
## Comparing against a baseline (part 3)
