# Improve Accessibility | Cypress Accessibility Documentation
...
For guidance on preventing regressions and enforcing accessibility policies, explore our [Blocking Pull Requests Section](/accessibility/block-pull-requests).
