...
export const NameEntitySchema = new EntitySchema({
    name: "name",
    columns: {
        first: {
            type: "varchar",
...
const ASchema = new EntitySchema({
    target: A,
    name: "A",
    type: "entity-child",
...
const BSchema = new EntitySchema({
    target: B,
    name: "B",
    type: "entity-child",
...
const CSchema = new EntitySchema({
    target: C,
    name: "C",
    type: "entity-child",
