...
## 1. Set up your Node.js and Prisma application (part 2)
...
## 3. Run the app and database together with Docker Compose (part 2)
...
## 3. Run the app and database together with Docker Compose (part 3)
