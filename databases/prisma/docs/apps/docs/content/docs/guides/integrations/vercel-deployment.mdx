...
:::note[Updated database limits]
Database limits have been increased across all plans. The **Free** plan now includes **50 databases**, and **paid plans** (Starter, Pro, Business) each include **1,000 databases**. See the [pricing page](https://www.prisma.io/pricing) for the full breakdown.
:::

The billing plan determines database limits and features. Available plans:

## Required API keys and environment variables (part 2)

- `free` - Limited to 50 databases, suitable for development
...
## Step-by-step deployment process (part 2)
...
## Step-by-step deployment process (part 3)
