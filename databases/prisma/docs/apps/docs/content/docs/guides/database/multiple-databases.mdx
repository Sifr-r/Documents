...
## 2. Set up your databases and Prisma Clients (part 2)
...
## 2. Set up your databases and Prisma Clients (part 3)
...
## 4. Integrate multiple Prisma Clients in your Next.js app (part 2)
