...
## Defining project-specific rules with .windsurfrules (part 2)
...
## Defining project-specific rules with .windsurfrules (part 3)
...
```prisma title="schema.prisma" showLineNumbers tab="Result"
generator client {
