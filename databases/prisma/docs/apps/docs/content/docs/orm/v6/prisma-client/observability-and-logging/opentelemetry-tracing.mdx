...
![Example Prisma Client trace structure showing parent and child spans for a database operation (serialization, query engine, database query).](/img/v6/orm/prisma-client/observability-and-logging/trace-diagram.png)
...
## Get started with tracing in Prisma ORM (part 2)
...
![Jaeger UI](/img/v6/orm/prisma-client/observability-and-logging/jaeger.png)
