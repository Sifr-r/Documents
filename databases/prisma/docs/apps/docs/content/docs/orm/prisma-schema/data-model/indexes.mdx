...
## Index configuration (part 6)

The default operator class (marked with ✅) can be omitted from the index definition.

## Index configuration (part 7)
