...
## Defining project-specific rules with .cursorrules (part 2)
...
```text copy tab="Prompt to generate Prisma schema"
...
```text copy tab="Prompt to generate a database query"
...
```text copy tab="Prompt to seed the database"
