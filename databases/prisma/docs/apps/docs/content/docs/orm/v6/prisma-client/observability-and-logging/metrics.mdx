...
If you need visibility into query or connection pool behavior, we recommend using the _native metrics provided by your database driver_ (for example, pool statistics) or setting up _OpenTelemetry_ for a more complete observability solution.
...
## Retrieve metrics in Prometheus format (part 2)
...
## Retrieve metrics in Prometheus format (part 3)
