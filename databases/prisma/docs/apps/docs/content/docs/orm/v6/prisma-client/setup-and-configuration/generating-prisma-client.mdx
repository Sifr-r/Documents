...
![Graphical illustration of the typical workflow for generation of Prisma Client](/img/v6/orm/prisma-client/setup-and-configuration/prisma-client-generation-workflow.png)
...
![The .prisma and @prisma folders](/img/v6/orm/prisma-client/setup-and-configuration/prisma-client-node-module.png)
