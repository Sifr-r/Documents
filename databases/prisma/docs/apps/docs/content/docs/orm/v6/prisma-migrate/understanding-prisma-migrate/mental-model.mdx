...
![Model-first migration flow](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/entity-first-migration-flow.png)
...
![Database-first migration flow](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/database-first-migration-flow.png)
...
![Prisma Migrate workflow](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-lifecycle.png)
...
![Prisma Migrate "state management"](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-state-mgt.png)
...
![Prisma Migrate dev flow](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-dev-flow.png)
...
![A cartoon that shows how the shadow database works.](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/shadow-database.png)
...
![Revert database schema with `migrate diff`](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-diff-flow.png)
...
![prisma db push development flow](/img/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/db-push-flow.png)
...
![Workflow of Prisma Migrate](/img/v6/orm/prisma-migrate/workflows/deploy-db.png)
