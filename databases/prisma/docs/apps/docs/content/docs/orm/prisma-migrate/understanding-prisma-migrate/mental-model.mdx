...
![Model-first migration flow](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/entity-first-migration-flow.png)
...
![Database-first migration flow](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/database-first-migration-flow.png)
...
![Prisma Migrate workflow](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-lifecycle.png)
...
![Prisma Migrate "state management"](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-state-mgt.png)
...
![Prisma Migrate dev flow](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-dev-flow.png)
...
![A cartoon that shows how the shadow database works.](/img/orm/prisma-migrate/understanding-prisma-migrate/shadow-database.png)
...
![Revert database schema with `migrate diff`](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/prisma-migrate-diff-flow.png)

You can use `migrate diff` to generate the SQL that either:

## Evolve your database schema with Prisma Migrate (part 2)
...
![prisma db push development flow](/img/orm/prisma-migrate/understanding-prisma-migrate/mental-model-illustrations/db-push-flow.png)
...
![Workflow of Prisma Migrate](/img/orm/prisma-migrate/workflows/deploy-db.png)

The command should be run in an automated CI/ CD environment, for example GitHub Actions.

## Evolve your database schema with Prisma Migrate (part 3)
