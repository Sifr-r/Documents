...
See the [Prisma schema API reference](/orm/v6/reference/prisma-schema-reference) <span class="api"></span> for detailed information about each section of the schema.
...
- Run the [`prisma format`](/orm/v6/reference/prisma-cli-reference#format) <span class="api"></span> command.
