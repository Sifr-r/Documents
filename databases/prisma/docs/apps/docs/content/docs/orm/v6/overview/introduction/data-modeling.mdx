...
## Data modeling without Prisma ORM (part 2)
...
## Data modeling without Prisma ORM (part 3)
...
No matter which approach though, with Prisma ORM you never create application models in your programming language by manually defining classes, interfaces, or structs. Instead, the application models are defined in your [Prisma schema](/orm/v6/prisma-schema/overview):
...
## Data modeling with Prisma ORM (part 2)
