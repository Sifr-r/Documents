...
- You are [baselining](/orm/v6/prisma-migrate/workflows/baselining) a production environment
...
<div style={{ margin: "2.5rem auto" }}>
  ⛔ <strong>We strongly discourage this solution due to the following reasons</strong>
</div>
